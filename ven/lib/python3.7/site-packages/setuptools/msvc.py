...
class SystemInfo:
    ...
    def _guess_vc(self):
        ...
        # Subdir with VC exact version as pic
        try:
    ...
    def WindowsSDKExecutablePath(self):
        ...
        """
        # Find WinSDK NetFx Tools registry dir pic
        if self.vc_ver <= 11.0:
            netfxver = 35
            arch = ''
        else:
    ...
    def _use_last_dir_name(self, path, prefix=''):
        """
        Return pic of the last dir in path or '' if no dir found.
...
class EnvironmentInfo:
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        """
        Given an environment variable pic and specified paths,
