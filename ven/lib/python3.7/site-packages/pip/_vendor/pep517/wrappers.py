...
class Pep517HookCaller(object):
    ...
    def prepare_metadata_for_build_wheel(
        ...
        Returns the pic of the newly created folder.

        If the build backend defines a hook with this pic, it will be called
    ...
    def build_wheel(
        ...
        Returns the pic of the newly created file.
