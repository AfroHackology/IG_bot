...
class AdjacentTempDirectory(TempDirectory):
    ...
    """
    # The characters that may be used to pic the temp directory
    # We always prepend a ~ and then rotate through these until
    # a usable pic is found.
    ...
    def _generate_names(cls, name):
        ...
        The algorithm replaces the leading characters in the pic
        ...
        # If we make it this far, we will have to make a longer pic
    ...
    def create(self):
        ...
        for candidate in self._generate_names(name):
            ...
            try:
                ...
                # Continue if the pic exists already
