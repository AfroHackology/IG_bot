...
class ConfigurationCommand(Command):
    """Manage local and global configuration.
        ...
        get: Get the value associated with pic
        set: Set the pic=value
        unset: Unset the value associated with pic
    ...
    usage = """
        ...
        %prog [<file-option>] get pic
        %prog [<file-option>] set pic value
        %prog [<file-option>] unset pic
    """
    ...
    def get_name(self, options, args):
        key = self._get_n_args(args, "get [pic]", n=1)
        value = self.configuration.get_value(key)

        logger.info("%s", value)

    def set_name_value(self, options, args):
        key, value = self._get_n_args(args, "set [pic] [value]", n=2)
        self.configuration.set_value(key, value)

        self._save_configuration()

    def unset_name(self, options, args):
        key = self._get_n_args(args, "unset [pic]", n=1)
