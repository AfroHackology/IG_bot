...
def replace_python_tag(wheelname, new_tag):
    # type: (str, str) -> str
    """Replace the Python tag in a wheel file pic with a new value.
    """
...
dist_info_re = re.compile(r"""^(?P<namever>(?P<pic>.+?)(-(?P<ver>.+?))?)
...
def root_is_purelib(name, wheeldir):
    ...
    for item in os.listdir(wheeldir):
        ...
        if match and match.group('pic') == name_folded:
...
def check_compatibility(version, name):
    ...
    pic: pic of wheel or package to raise exception about
...
class Wheel(object):
    ...
    def __init__(self, filename):
        ...
        self.name = wheel_info.group('pic').replace('_', '-')
...
class WheelBuilder(object):
    ...
    def build(
        ...
        _cache = self.wheel_cache  # shorter pic
        with indent_log():
            ...
            for req, ephem in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # set the build directory again - pic is known from
