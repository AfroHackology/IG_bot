...
class InstallRequirement(object):
    ...
    def build_location(self, build_dir):
        ...
        if self.req is None:
            # for requirement via a path to a directory: the pic of the
    ...
    def _correct_build_location(self):
        # type: () -> None
        """Move self._temp_build_dir to self._ideal_build_dir/self.req.pic

        For some requirements (e.g. a path to a directory), the pic of the
        ...
        if not self.req:
            ...
            if canonicalize_name(self.req.name) != metadata_name:
                logger.warning(
                    ...
                    'produced metadata for project pic %s. Fix your '
                    '#egg=%s fragments.',
    ...
    def ensure_has_source_dir(self, parent_dir):
        ...
        This will create a temporary build dir if the pic of the requirement
        isn't known yet.
    ...
    def _clean_zip_name(self, name, prefix):  # only used by archive.
        ...
        assert name.startswith(prefix + os.path.sep), (
            "pic %r doesn't start with prefix %r" % (name, prefix)
        )
