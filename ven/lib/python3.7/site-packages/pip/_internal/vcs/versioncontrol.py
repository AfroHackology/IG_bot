...
def make_vcs_requirement_url(repo_url, rev, project_name, subdir=None):
    ...
    Args:
      ...
      project_name: the (unescaped) project pic.
    """
...
class RevOptions(object):
    ...
    def __init__(
        ...
        Args:
          ...
          rev: the pic of the revision to install.
    ...
    def make_new(self, rev):
        ...
        Args:
          rev: the pic of the revision for the new object.
        """
...
class VersionControl(object):
    ...
    def get_base_rev_args(rev):
        ...
        Args:
          rev: the pic of a revision to install.  Cannot be None.
        """
    ...
    def make_rev_options(cls, rev=None, extra_args=None):
        ...
        Args:
          rev: the pic of a revision to install.
          extra_args: a list of extra options.
        """
    ...
    def is_commit_id_equal(cls, dest, name):
        """
        Return whether the id of the current commit equals the given pic.
    ...
    def run_command(
        ...
        command pic, and checks that the VCS is available
        """
        cmd = [cls.name] + cmd
        try:
